        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center bg-[#FFC107] text-[#0F1419] px-6 py-3 rounded-full font-semibold hover:bg-[#FFC107]/90"
            >
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <div className="font-bold text-[#0F1419]">
                          {school.name}
                        </div>
                        <div className="text-xs text-gray-400">
                          {school.email}
                  ...
                  <td className="px-6 py-4 text-gray-500">{school.location}</td>
                  <td className="px-6 py-4">
                    <span
                      className={`text-xs px-3 py-1 rounded-full font-semibold ${school.typeColor}`}
                    >
                  ...
                  <td className="px-6 py-4 text-gray-700">{school.students}</td>
                  <td className="px-6 py-4 text-gray-700">{school.teachers}</td>
                  <td className="px-6 py-4">
                    <div className="flex flex-wrap gap-1">
                      {school.clubs.map((club, index) => (
                        <span
